...
#=================================file path============================
# 设定路径
rna_path <- file.path("/data/share_data/yuytest/gmi_data/unprocessed", "GSM3681518_MNC_RNA_counts.tsv.gz")
adt_path <- file.path("/data/share_data/yuytest/gmi_data/unprocessed", "GSM3681519_MNC_ADT_counts.tsv.gz")
hto_path <- file.path("/data/share_data/yuytest/gmi_data/unprocessed", "GSM3681520_MNC_HTO_counts.tsv.gz")
...
write.csv(cell_info_adt, file = "/data/share_data/yuytest/gmi_data/unprocessed/bm2_adt_cell_info.csv", row.names = FALSE)
feature_info_adt <- rownames(adt@assays$adt)
write.csv(feature_info_adt, file = "/data/share_data/yuytest/gmi_data/unprocessed/bm2_adt_feature_info.csv", row.names = FALSE)
matrix_data <- as.matrix(adt@assays$adt@layers$counts)
write.csv(matrix_data, file = "/data/share_data/yuytest/gmi_data/unprocessed/bm2_adt_matrix_data.csv")
# ==================================adt saveing==================================


# ==================================rna saveing==================================
# 提取细胞信息
cell_info_rna <- rownames(rna@meta.data)
write.csv(cell_info_rna, file = "/data/share_data/yuytest/gmi_data/unprocessed/bm2_rna_cell_info.csv", row.names = FALSE)
# 提取特征信息
feature_info_rna <- rownames(rna@assays$rna)
write.csv(feature_info_rna, file = "/data/share_data/yuytest/gmi_data/unprocessed/bm2_rna_feature_info.csv", row.names = FALSE)
# 密集矩阵
rna_counts <- rna@assays$rna@layers$counts
Matrix::writeMM(rna_counts, file = "/data/share_data/yuytest/gmi_data/unprocessed/bm2_rna_matrix_data.mtx")
