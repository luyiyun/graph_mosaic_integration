...
def train_midas(data_dir, output_dir, max_epochs=2000):
    ...
    # 修改各模态的编码器和解码器配置
    # RNA 模态
    configs['dims_before_enc_rna'] = [1677]
    configs['dims_after_dec_rna'] = [1677]
    configs['distribution_dec_rna'] = 'POISSON'
    configs['lam_recon_rna'] = 1
    
    # ATAC 模态
    configs['dims_before_enc_atac'] = [25734]
    configs['dims_after_dec_atac'] = [25734]
...
if __name__ == "__main__":
    data_dir = "/data/share_data/yuytest/gmi_data/midas/MOP"
    output_dir = "/home/yuyipei/graph_mosaic_integration/result/midas_MOP"
    h5ad_path = "/home/yuyipei/graph_mosaic_integration/result/midas_MOP/embeddings.h5ad"
