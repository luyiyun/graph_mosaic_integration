...
def run_harmony_pipeline(mdata_path, h5ad_path, seeds):
    ...
    mdata = data_infor_integrate(mdata, feature_key="cell_type", saved_feature_name="label", target_attr="obs")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mdata_path",
        type=str,
        default="/data/share_data/yuytest/gmi_data/triple.h5mu",
        help="MuData 文件路径",
    )
    parser.add_argument(
        "--h5ad_path",
        type=str,
        default="/home/yuyipei/graph_mosaic_integration/result/harmony_triple/embeddings.h5ad",
        help="保存的 h5ad 文件路径",
    )
