...
def train_midas(data_dir, output_dir, max_epochs=2000):
    ...
    batch_names = ["batch_b1-atac", "batch_b2-rna", "batch_b3-methy"]  # 根据 triple 数据集实际批次名称
    ...
    dims_x = {
        "rna": [2000],  # RNA data is represented as a cell x 200 matrix.
        "adt": [3922],  # ADT data is represented as a cell x 100 matrix.
        "atac": [
            4124
